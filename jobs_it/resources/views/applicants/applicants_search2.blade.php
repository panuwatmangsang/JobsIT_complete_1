    ...
    <div class="container" style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-md-12" style="margin-top:20px;">
                {!! Form::open(['route' => 'search2','method' => 'get']) !!}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="date" style="float: right;">
                            ...
                            <a type="button" style="margin-left: 80px;" href="{{ route('applicants.applicants_see_detail_search2',$ent['_source']['jobs_id']) }}" class="btn btn-primary">ดูรายละเอียด</a>
                        </div>
